# `API-Project-Meetup-Documentation`

## Database Schema Design

`CREATE TABLE api-project.user (id INTEGER PRIMARY KEY AUTOINCREMENT, username VARCHAR(30) NOT NULL UNIQUE, email VARCHAR(256) NOT NULL UNIQUE, hashedPassword VARCHAR BINARY(255) NOT NULL, createdAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP)`
...
* Request
  * Method: PATCH
  * URL: /users/:userId/groups/:groupId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /users/:userId/groups/:groupId/venues
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: POST
  * URL: /users/:userId/groups/:groupId/venues/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: /users/:userId/groups/:groupId/venues/:venueId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /search/groups/:groupId/events
  * Body: none
  ...
  * Body:
    ...
    ```json
    {
      "Events": [
        ...
        {
          "id": 1,
          "groupId": 1,/user/:userId/groups/:groupId
          "venueId": 1,
          "name": "Tennis Singles",
          "type": "In Person",
          "startDate": "2021-11-20 20:00:00",
...
* Request
  * Method: POST
  * URL: /users/:userId/groups/:groupId/events/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: PUT
  * URL: /users/:userId/groups/:groupId/event/:eventId/edit
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /user/:userId/groups/:groupId/members/new
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: POST
  * URL: /users/:userId/groups/:groupId/members/:memberId/status
  * Headers:
    * Content-Type: application/json
  * Body:
